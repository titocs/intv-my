        ...
        <div className='lg:flex lg:gap-4'>
          ...
          <div className='bg-white lg:basis-3/5 rounded-lg'>
            <div className="p-5 md:px-8 ">
              ...
              <p className='text-grey-custom-800 mb-3'>Add your details to create a personal touch to your profile.</p>
            </div>
            
            <div className="bg-grey-custom-100 p-5 mx-5 rounded-md my-5 pb-8 md:p-8 md:mx-8">
              <div className="mb-6">
                <Input disabled={true} label="First Name" value={data.data?.firstName || ''} icon=""/>
              </div>
              <div className="mb-6">
                <Input disabled={true} label="Last Name" value={data.data?.lastName || ''} icon=""/>
              </div>
              <div className="mb-6">
                <Input disabled={true} label="Email" value={data.data?.email || ''} icon=""/>
              </div>
            </div>
          </div>
        </div>
